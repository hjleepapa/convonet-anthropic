...
2. **Purchase Phone Numbers:**
   - Purchase an inbound number (e.g., `+12345677818`)
   - Optionally purchase a trunk number for SIP (e.g., `+12345677818`)
...
4. **Assign Phone Numbers:**
   - Add inbound number: `+12345677818`
   - Add trunk number (if purchased): `+12345677818`
...
COMPOSIO_PROJECT_ID=playground_key

# ===== TWILIO =====
TWILIO_ACCOUNT_SID=ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_AUTH_TOKEN=your-twilio-auth-token
TWILIO_PHONE_NUMBER=+12345678900
TWILIO_TRUNK_NUMBER=+12345677818  # Optional, for SIP trunking
...
TEST_VOICE_PIN=xxxx    # Only used if ENABLE_TEST_PIN=true
...
1. **Call Twilio number**: `+12345677818`
